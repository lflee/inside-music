...
export const trackConfig = [
	{
		artist : 'Fung 峰 😲',
		track : 'The Greatest Evil',
		folder : 'TheGreatestEvil',
		intro : 'TheGreatestEvil',
		segments : 7,
		duration : 208,
		// duration : 5,
		trackNames : ['AllInOneTrack'],
		names : ['AllInOneTrack'],
		soundRings: {
			startColor: '#f7002d',
			endColor: '#00edaa',
	...
	} ,
	{
		...
		// duration : 5,
		trackNames : ['AllInOneTrack',
					  '400170__caroliney__chanting-sorority',
					  '400849__mindhealer__a-small-library-in-korea',
					  '401145__mcbjazz2__rutterfallssounds'
					 ],
		names : ['AllInOneTrack', '400170', '400849', '401145'],
		soundRings: {
			startColor: '#f7002d',
			endColor: '#00edaa',
			shape: 'triangle',
